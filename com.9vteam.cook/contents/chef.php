...
?>
<vscroll width="100%" height="100%" background-color="#eae9e0" id="packages">
	...
	<status action-name="package" status="<?php echo $package["pid"] == $packageId ? "selected":"";?>" reuse="package"
		 ...
		 width="100%" height="auto" background-color="#f7f8f0" margin-top="10" margin-left="10" margin-right="10">
		<div width="100%" height="auto" padding="10" layout="flow">
			<label width="100%" height="24" font="14" color="#333333" align="center">¥<?php echo $package["chefPrice"];?>&nbsp;/&nbsp;<?php echo $package["format"];?></label>
		...
		<img status="selected" src="@sel.png" width="16" height="16" left="auto" right="6"></img>
	</status>
	
	<?php }?>
	
	
	<div width="100%" height="auto" background-color="#f7f8f0" layout="flow" margin-top="10" padding="10" reuse="order" margin-left="10" margin-right="10">
		...
		<action action-name="orderCreate" width="100%" height="44" margin-left="20" margin-right="20" margin-top="20" background-color="#e43a00">
			<label width="auto" height="auto" left="auto" right="auto" top="auto" bottom="auto" color="#ffffff" font="18 bold">预&nbsp;&nbsp;约</label>
		</action>
