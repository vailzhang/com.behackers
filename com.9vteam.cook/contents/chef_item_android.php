...
<div width="100%" height="auto" padding-left="10" padding-right="10" padding-top="10">
<action action-name="url" uri="<?php echo $baseUri;?>chef?title=<?php echo urlencode("预约厨师");?>&amp;chefId=<?php echo $chef["pid"];?>&amp;packageId=<?php echo $package["pid"]; ?>"
	 width="100%" height="auto" layout="flow" background-color="#f7f8f0" margin-top="10">
	<div width="100%" height="80" padding="10">
		...
		<view id='star' viewClass='com.vteam.cook.views.StarView' score='<?php echo $chef["score"];?>' left='70' top='45' height='20' width='80'></view>
		...
		<img width="22" height="22" left="70" top="20" src="<?php echo COObjectBooleanValueForKey($chef,"hasSecurityIDCode") ? '@com.vteam.cook.R.drawable.sec_id' :'@com.vteam.cook.R.drawable.sec_id_dis';?>"></img>
	</div>
	<div width="100%" height="1" background-color="#eae9e0"></div>
	<div width="100%" height="auto" padding="10" layout="flow">
		<label width="100%" height="24" font="14" color="#333333" align="center"><![CDATA[¥<?php echo COObjectStringValueForKey($package,"chefPrice");?> / <?php echo COObjectValueForKey($package, "format");?>]]></label>
