...
?>
<vscroll width="100%" height="100%" background-color="#eae9e0">
	...
	<div width="100%" height="160">
		<page width="100%" height="100%" loops="3" page-id="pageControl">
			<action width="100%" height="100%" action-name="url" uri="home/chef?chefId=1&packageId=2&title=<?php echo urlencode("预约厨师");?>">
				<img width="100%" height="100%" src="<?php echo RESURL("res:///images/2014-06-05/14ceda77154254ac7c7ac2507e6262d5.jpg",600);?>"></img>
				
			</action>
			<action width="100%" height="100%" action-name="url" uri="home/chef?chefId=2&packageId=2&title=<?php echo urlencode("预约厨师");?>">
				<img width="100%" height="100%" src="<?php echo RESURL("res:///images/2014-06-05/d06064b69c6b00ffdaffa988fde01710.jpg",600);?>"></img>
				
			</action>
			<action width="100%" height="100%" action-name="url" uri="home/chef?chefId=3&packageId=2&title=<?php echo urlencode("预约厨师");?>">
	...
	<div width="100%" height="auto" layout="flow" background-color="#f7f3e8">
		...
		<div width="100%" height="80" layout="flow">
			<?php while($index < 4 && $index< count($cuisines)) {
				...
				?>
			<action width="25%-1" height="100%" action-name="url" uri="home/chef-search?title=<?php echo urlencode($cuisine["title"]);?>&cuisineId=<?php echo $cuisine["cid"];?>">
	...
	<div width="100%" height="auto" layout="flow" padding="10">
	...
	<div width="100%" height="auto" layout="flow" padding="10" margin-bottom="-20">
